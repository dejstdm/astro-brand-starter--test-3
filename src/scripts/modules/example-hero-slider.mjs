...
export function exampleHeroSlider() {
  document.addEventListener('DOMContentLoaded', () => {
    // Initialize hero slider
    const heroSlider = document.querySelector('.js__example-hero-slider');
...
function animateSlideContent(slide, direction) {
  const textSection = slide.querySelector('.example-hero-slider__text-section');
  const visualSection = slide.querySelector('.example-hero-slider__visual-section');
...
function initMobileMenu() {
  const mobileToggle = document.querySelector('.example-hero-slider__mobile-toggle');
  const navMenu = document.querySelector('.example-hero-slider__nav-menu');
  const navActions = document.querySelector('.example-hero-slider__nav-actions');
  ...
  if (mobileToggle && navMenu) {
    ...
    document.addEventListener('click', (e) => {
      if (!e.target.closest('.example-hero-slider__nav-content')) {
        navMenu.classList.remove('mobile-open');
        navActions?.classList.remove('mobile-open');
        mobileToggle.classList.remove('active');
      }
